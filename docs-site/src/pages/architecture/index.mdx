...
These are non-negotiable choices with specific rationale. For the full list, see [SPEC.md §14](https://github.com/contentful/skill-kit/blob/main/SPEC.md#14-opinionated-decisions).
