...
**Use MCP tools if available.** If you have `mcp__get-to-know-you__start` and
`mcp__get-to-know-you__advance`, use MCP mode. Only fall back to CLI mode if MCP tools
