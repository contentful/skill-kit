...
function generateIndex() {
  const lines = [
    ...
    '',
    "export default reference({ name: 'ts-patterns' })",
    "  .topic('generics', { content: () => import('./topics/generics.md') })",
    "  .topic('error-handling', { content: () => import('./topics/error-handling.md') })",
    '  .build();',
    '```',
    '',
    '```typescript',
    "import { skill, reference } from '@contentful/skill-kit';",
    '',
    "export default skill({ name: 'help', entry: 'dispatch' })",
    "  .subskill('doctor', doctorSkill)",
    "  .topic('rate-limits', { content: () => import('./topics/rate-limits.md') })",
    '  .build();',
    '```',
    '',
  ];
